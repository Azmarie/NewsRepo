    ...
    <div className={s.root}>
      ...
      <div className={s.rightpart}>
        <div className={s.ourinitiatives}>
          ...
          <p className={s.info}>We aim to create a forward-thinking digital content platform which collects valuable news, information, and blogs from all sources.</p>
        </div>
        <div className={s.aboutus}>
          ...
          <p className={s.info}>We do concern about the copyright for every artiles we displayed. If you find there is any material which infringes your copyright, please let us know by email and provide the details (such as URL, your origin work, etc.), we will delete every infringements as soon as possible. </p>
